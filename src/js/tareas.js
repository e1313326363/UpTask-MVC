...
(function () {
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
        ...
        modal.addEventListener('click', function (e) {
            //delegation porque el formulario se crea al click 
            e.preventDefault();
        ...
        try {
            ...
            if (resultado.respuesta.tipo === 'exito') {
                Swal.fire({
                    ...
                    customClass: {
                        popup: 'swal-success-tarea-popup',
                        title: 'swal-success-tarea-title',
                        htmlContainer: 'swal-success-tarea-text',
                        confirmButton: 'swal-success-tarea-btn'
                    }
                });
